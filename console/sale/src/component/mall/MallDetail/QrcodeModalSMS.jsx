...
import {Row, Col, Form, Switch, Input, Button, Icon, message} from 'antd';
  ...
  render() {
    ...
    return (<div style={{fontSize: 14, padding: 20, minHeight: 483}}>
      <Row style={{textAlign: 'center', marginBottom: 20}}>
        <span style={{color: '#2db7f5'}}><Icon type="info-circle"/></span> 通过二维码收款的通知将通过短信发送到以下手机，通知开关可以控制是否发送短信
      </Row>
