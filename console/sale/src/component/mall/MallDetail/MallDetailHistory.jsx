  ...
  },
  {
    ...
    render(text, record) {
      ...
      if (actionCode === 'CREATE_SHOP' || actionCode === 'MODIFY_SHOP') {
        return <a href={'#/approval-flow/complex/' + record.orderId + '/CREATE_SHOP?isOpen=true'} target="_blank">查看详情</a>;
      }
      if (actionCode === 'SURROUND_SHOP') {
        return <a href={'#/approval-flow/surroundDetail/' + record.orderId + '/SURROUND_SHOP'} target="_blank">查看详情</a>;
      }
      if (actionCode === 'REMOVE_SHOP') {
        return <a href={'#/approval-flow/surroundDetail/' + record.orderId + '/REMOVE_SHOP'} target="_blank">查看详情</a>;
      }
...
const MallDetailHistory = React.createClass({
  propTypes: {
    id: PropTypes.string,
  },
...
export default MallDetailHistory;
