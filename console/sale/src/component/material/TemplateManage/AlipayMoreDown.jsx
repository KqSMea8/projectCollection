...
import AlipayInvalidModel from './AlipayInvalidModel';
const AlipayMoreDown = React.createClass({
  propTypes: {
    id: PropTypes.any,
    show: PropTypes.bool,
  ...
  render() {
    ...
    const menu = (
      <Menu>
        ...
        <Menu.Divider />
        <Menu.Item key="3">
          <a target="_blank" href={'#/material/templatemanage/createtemplate?tab=alipay&id=' + id}>复制</a>
        </Menu.Item>
      </Menu>
    );
    return (<div>
      {currentPage === 'tabList' ?
        ( <div><a target="_blank" href={'#/material/templatemanage/alipaytempdetail/' + id} style={{margin: '0 8px'}}>详情　| </a>
      ...
      {currentPage === 'tempInfo' ?
        ...
        <a className="ant-btn-primary ant-btn" target="_blank" href={'#/material/templatemanage/createtemplate?tab=alipay&id=' + id} style={{margin: '0 8px'}}>复制</a>
