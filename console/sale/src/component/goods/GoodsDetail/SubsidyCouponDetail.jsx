...
const SubsidyCouponDetail = React.createClass({
  propTypes: {
            ...
            <div className="kb-detail-main">
              ...
              <div className="detail-float-left">
                <Breadcrumb separator=">">
                  <Breadcrumb.Item key="1" href="#/goods/list">补贴劵</Breadcrumb.Item>
                  ...
                  <div className="kb-discount-detail">
                    ...
                    <table className="kb-detail-table-6">
                      <tbody>
                        ...
                        <tr>
                          <td className = "kb-detail-table-label">每个用户领取数量限制</td>
                          <td>{formatEachUserReceivedLimitNum(data.subsidyInfo)}</td>
                          ...
                          <td>
                            {data.dayAvailableNum === '--' ? '不限制' : data.dayAvailableNum}
                          </td>
                        </tr>
                        <tr>
...
export default SubsidyCouponDetail;
