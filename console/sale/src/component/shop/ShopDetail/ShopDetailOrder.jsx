...
const columns = [
  ...
  },
  {
    ...
    dataIndex: '',
    render(text, record) {
      return permission('MERCHANT_ORDER_DETAIL') ? <a href={window.APP.salesmngUrl + '/order/orderInfo.htm?orderNum=' + record.merFromOrderNum} target="_blank">查看订单详情</a> : '';
    },
  },
];

const ShopDetailOrder = React.createClass({
  propTypes: {
    id: PropTypes.string,
  },
...
export default ShopDetailOrder;
