...
const QrcodeModalShop = React.createClass({
  ...
  getInitialState() {
    return {
      activeKey: 'DOOR_PASTER_148_210_GEN',
      qrCodeUrl: '',
      errorMsg: null,
    };
  },
  ...
  render() {
    ...
    return (<div style={{textAlign: 'center', fontSize: 14, padding: 20, minHeight: 483}}>
      ...
      <Row style={{margin: '20px 0'}}>
        <ButtonGroup>
          <Button
            type={activeKey === 'DOOR_PASTER_148_210_GEN' ? 'primary' : 'ghost'}
            onClick={this.onTemplateSwitch.bind(this, 'DOOR_PASTER_148_210_GEN')}
          >台卡  148 x 210mm(大)</Button>
          <Button
            type={activeKey === 'DOOR_PASTER_110_150_GEN' ? 'primary' : 'ghost'}
            onClick={this.onTemplateSwitch.bind(this, 'DOOR_PASTER_110_150_GEN')}
