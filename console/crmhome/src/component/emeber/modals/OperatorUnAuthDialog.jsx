...
class OperatorDialog extends React.Component {
  ...
  componentDidMount() { // 从中取出要删除的值
    const {operatorId, deleteItems, featureDelete} = this.props.params;
    ...
    Array.prototype.slice.call(document.querySelectorAll('.J_operatorId')).forEach(domItem => domItem.value = operatorId);
