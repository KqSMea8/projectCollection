...
const BudgetAmountFormItem = React.createClass({
  propTypes: {
    ...
    validateDayAvailableNum: PropTypes.bool, // 是否关联校验dayAvailableNum字段值
  },
  ...
  checkBudgetAmount(rule, value, callback) {
    const fields = ['budgetAmountType'];
    if (this.props.validateDayAvailableNum && this.props.form.getFieldValue('type') !== 'REAL_TIME_SEND') {
      fields.push('dayAvailableNum');
    }
