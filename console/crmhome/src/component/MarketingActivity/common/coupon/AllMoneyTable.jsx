...
const AllMoneyTable = React.createClass({
  propTypes: {
      ...
      <table className="kb-detail-table-2">
        <tbody>
          ...
          <tr>
            ...
            <td>{data.worthValue}元</td>
          </tr>
          <tr>
            <td className="kb-detail-table-label">使用条件</td>
            <td>{data.useCondtion ? <span>订单满{data.useCondtion}元可享用</span> : '不限制'}</td>
          </tr>
          <tr>
