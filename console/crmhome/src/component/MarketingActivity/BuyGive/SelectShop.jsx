...
class SelectShop extends Component {
  constructor(props) {
    ...
    this.cityUrl = '/goods/itempromo/getShops.json';
    this.shopUrl = props.shopUrl || '/goods/itempromo/getShopsByCityForNewCamp.json';
    this.categoryUrl = '/goods/queryAllCategorys.json';
