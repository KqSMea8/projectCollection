...
const ABDetail = React.createClass({
  propTypes: {
  ...
  render() {
    ...
    const sendRules = itemDiscountRule.sendRules;
          ...
          <div className="kb-detail-main">
            ...
            <table className="kb-detail-table-6">
              ...
              <tr>
                ...
                <td className="kb-detail-table-label">购买及赠送商品组合</td>
                <td>
                  <a href="#" onClick={(e)=> { e.preventDefault(); this.setState({showSKUCodeModal: true});}}>{sendRules.length}个组合</a>
                </td>
              </tr>
              <tr>
                <td className="kb-detail-table-label">购买商品名称</td>
                <td>{sendRule.buyItemName}</td>
                <td className="kb-detail-table-label">赠送商品名称</td>
                <td>{sendRule.sendItemName}</td>
                  ...
                  return (
                    <tr key={i}>
                      ...
                      <td>
                        买<br />
                        {
                          p.buySkus.map((b) => <p key={b}>{b}</p>)
                        }
                      </td>
                      <td>
                        送<br />
                        {
                          p.sendSkus.map((k) => <p key={k}>{k}</p>)
                        }
                      </td>
                    </tr>
                  );
