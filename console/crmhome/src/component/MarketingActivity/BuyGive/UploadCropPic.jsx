 ...
 * 上传裁剪的图片
 * @author 柚茜
 * @description 注意下列文件依赖此组件：
 *  - /src/component/MarketingActivity/BuyGive/BuyGive.jsx
 *  - /src/component/MemberMarketing/retailers/detail/ModifyModal.jsx
 */
const UploadCropPic = React.createClass({
  ...
  */
  ...
  render() {
    ...
    return (<div className="myImgCrop">
        <ImgUploadCrop {...props} />
    </div>);
  },
});
