...
import {logSourceMap, logChannelMap, logShopActionMap, logResultMap, logMallFilterList} from '../../../common/OperationLogMap';
  ...
  },
  {
    ...
    render(text, record) {
      ...
      if (actionCode === 'CREATE_SHOP' || actionCode === 'MODIFY_SHOP') {
        return <a href={'#/mall/flow-detail/' + record.orderId + '/CREATE_SHOP'} target="_blank">查看详情</a>;
      }
      return null;
    },
  },
