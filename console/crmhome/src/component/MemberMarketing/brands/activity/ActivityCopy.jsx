...
const ActivityCopy = React.createClass({
  propTypes: {
    ...
    ajax({
      ...
      success: (res) => {
        if (res.status === 'success') {
          ...
          res.discountForm.displayStatus = '';
      ...
      <div className="kb-activity-create">
        ...
        <div className="kb-detail-main">
          ...
          <Breadcrumb separator=">">
            ...
            <Breadcrumb.Item>创建营销活动</Breadcrumb.Item>
          </Breadcrumb>

          {
            formData ? <CreateForm roleType="brand" actionType="copy" allData={allData} initData={formData} query={this.props.location.query} params={this.props.params} /> : null
          }
        </div>
      </div>
    );
