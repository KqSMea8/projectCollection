...
import { GroupsAddName, GroupsAddBasic, GroupAddIndustry, GroupsAddSubmit, GroupsAddConsumer,
  GroupsAddLocation, GroupAddThird, convert, validate, filter, GroupCustomerDivide, GroupsAddTarget } from '../../../common/GroupsAdd';
...
class RetailersGroupsAddCate7 extends React.Component {
  static propTypes = {
    ...
    return (
      <retailers-groups-add-cate7>
        ...
        <Form horizontal form={form} onSubmit={::this.onSubmit}>
          <GroupsAddName form={form} count={count} onClick={::this.onClick} type="cate7" />
          <div><strong>{tagsCount}</strong> 个标签已选</div>
          <GroupsAddTarget handleTarget={::this.handleTarget} handleCheck={::this.handleCheck} isContainThridTag/>
          <GroupsAddBasic form={form} type="cate7" showLinkDate={showCheck}/>
          <GroupsAddConsumer form={form} />
          <GroupsAddLocation form={form} />
          <GroupAddIndustry form={form} type="cate7" />
          <GroupCustomerDivide form={form} />
          <GroupAddThird form={form} />
          <GroupsAddSubmit />
        </Form>
      </retailers-groups-add-cate7>
    );
...
export default createForm()(RetailersGroupsAddCate7);
