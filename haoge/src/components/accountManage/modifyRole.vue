<template>
    <div class="wyx addRole">
        ...
        <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="150px" class="demo-ruleForm"
            ...
            <!--<el-input v-model.number="ruleForm2.age" clearable></el-input>-->
            <!--</el-form-item>-->
            <el-form-item>
                <el-button size="small" type="primary" @click="submitForm('ruleForm2',success,error)">提交修改</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            success(children) {
                ...
                submitJson.roleId=this.$route.params.id;
                console.log(submitJson);
                classPost.roleUpdate(submitJson)
                    .then((res) => {
                        console.log(res)
                        if (res.status = '1') {
//                成功
...
//      添加角色成功
            open1() {
                this.$alert('您已成功修改角色' + this.ruleForm2.roleName, '修改成功', {
                    confirmButtonText: '确定',
                    type: 'success',
                    callback: action => {
                        this.$eventBus.$emit('nav')
        ...
        mounted: function () {
            classPost.roleDetail({roleId: this.$route.params.id})
                .then((res) => {
                    ...
                    this.ruleForm2.roleName=res.data.roleName;
                    this.ruleForm2.remark=res.data.remark;
...
//                                选中
//                                    console.log(res.data.resourceTreeList[i].childList[j].orderId)
...
//                    console.log(this.checkData);
                    this.ruleForm2.resourceIdList=this.checkData;
